...
int socketsAcceptees[TAILLE_FILE_ATTENTE]; // Page 85
...
int main(int argc,char* argv[])
{
    ...
    {
        printf("Erreur...\n");
        printf("Veuillez indiquer le port!!!! \n");
        exit(1);
    }
